...
size_t SerializadorNumerico::Serializar(char *buff, uNumber numero, eValueType tipo)
{
	...
	switch (size)
	{
		case 1:
		{
			...
			{
				__int8 value = numero.entero.enteroConSigno.entero8ConSigno;
				*buff++ = value;
			}
			else
			{
				unsigned __int8 value = numero.entero.enteroSinSigno.entero8SinSigno;
				*buff++ = value;
			}
		}
		break;
		...
		case 2:
		{
			if (tipo & Mascara_Signo)
			{
				__int16 value = numero.entero.enteroConSigno.entero16ConSigno;
				*buff++ = value >> 8;
				*buff++ = value;
			}
			else
			{
				unsigned __int16 value = numero.entero.enteroSinSigno.entero16SinSigno;
				*buff++ = value >> 8;
				*buff++ = value;
			}
		}
		...
		case 4:
		{
			if (tipo & Mascara_Signo)
			{
				__int32 value = numero.entero.enteroConSigno.entero32ConSigno;
				*buff++ = value >> 24;
				*buff++ = value >> 16;
				*buff++ = value >> 8;
				*buff++ = value;
			...
			{
				unsigned __int32 value = numero.entero.enteroSinSigno.entero32SinSigno;
				*buff++ = value >> 24;
				*buff++ = value >> 16;
				*buff++ = value >> 8;
				*buff++ = value;
		...
		{	if (tipo & Mascara_Signo)
			{
				__int64 value = numero.entero.enteroConSigno.entero64ConSigno;
				*buff++ = value >> 56;
				*buff++ = value >> 48;
				*buff++ = value >> 40;
				*buff++ = value >> 32;
			...
			{
				unsigned __int64 value = numero.entero.enteroSinSigno.entero64SinSigno;
				*buff++ = value >> 56;
				*buff++ = value >> 48;
				*buff++ = value >> 40;
				*buff++ = value >> 32;
