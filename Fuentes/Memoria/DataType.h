...
{
	unsigned INT8 entero8SinSigno;
	unsigned INT16 entero16SinSigno;
	unsigned INT32 entero32SinSigno;
	unsigned INT64 entero64SinSigno;
};

union uEnteroConSigno
{
	INT8 entero8ConSigno;
	INT16 entero16ConSigno;
	INT32 entero32ConSigno;
	INT64 entero64ConSigno;	
};
